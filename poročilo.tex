...
\begin{figure}[t!]
  ...
  \begin{subfigure}[b]{1.2\linewidth}
    \includegraphics[width=\linewidth]{prva}
    \caption{Prvotna slika, vzeta z interneta.}
  \end{subfigure}
  \begin{subfigure}[b]{1.2\linewidth}
    \includegraphics[width=\linewidth]{druga}
    \caption{Rezultat, po izvedbi algoritma.}
  \end{subfigure}
\end{figure}
